...
<div class="page-header">   
    ...
    <?if($name == 'product'):?><p><a href="https://docs.open-eshop.com/add-product/" target="_blank"><?=__('Read more')?></a></p><?endif;?>
    <?if($name == 'license'):?><p><a href="https://docs.open-eshop.com/manage-licenses/" target="_blank"><?=__('Read more')?></a></p><?endif;?>
    <?if($name == 'user'):?><p><a href="https://docs.yclas.com/manage-users/" target="_blank"><?=__('Read more')?></a></p><?endif;?>
    <?if($name == 'role'):?><p><a href="https://docs.yclas.com/roles-work-classified-ads-script/" target="_blank"><?=__('Read more')?></a></p><?endif;?>
    <?if($name == 'crontab'):?><p><a href="https://docs.yclas.com/how-to-set-crons/" target="_blank"><?=__('Read more')?></a></p><?endif;?>
    <?=$extra_info_view?>
</div>
