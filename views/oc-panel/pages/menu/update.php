...
<form class="well form-horizontal"  method="post" action="<?=Route::url('oc-panel',array('controller'=>'menu','action'=>'update','id'=>$name))?>">
<!-- drop down selector -->
...
<a href="<?=Route::url('oc-panel',array('controller'=>'menu'))?>" class="btn btn-default ajax-load"><?=__('Cancel')?></a>
